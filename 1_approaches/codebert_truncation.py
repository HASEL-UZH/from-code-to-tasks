            ...
            if os.path.isdir(folder_path):
                ...
                if os.path.exists(commit_info_path):
                    with open(commit_info_path, "r") as json_file:
                        ...
                        pull_request_npy_file_path = os.path.join(folder_path, "pull_request_truncation_embedding.npy")
                        ...
                        code_npy_file_path = os.path.join(folder_path, "code_truncation_embedding.npy")
...
def generate_similarity_object():
    ...
    for sliding_window_subfolder in os.listdir(sliding_window_folder):
        ...
        for folder_code_diff in os.listdir(sliding_window_subfolder_path):
            ...
            code_embedding_file = os.path.join(folder_path_code_diff, "code_truncation_embedding.npy")
            ...
            for folder_pull_request in os.listdir(sliding_window_subfolder_path):
                ...
                pull_request_embedding_file = os.path.join(folder_path_pull_request, "pull_request_truncation_embedding.npy")
...
def calculate_cosine_similarity(code_embedding, task_description_embedding):
    code_embedding = torch.tensor(code_embedding)
    task_description_embedding = torch.tensor(task_description_embedding)
...
if __name__=="__main__":
    title = 'codebert truncation k=5'
    description = 'the code embeddings are truncated to match the sequence length of the pull request embeddings'
